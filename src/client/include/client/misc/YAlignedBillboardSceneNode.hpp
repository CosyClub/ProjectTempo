...
//! Scene node which is a billboard. A billboard is like a 3d sprite: A 2d
//! element, which always looks to the camera.
class YAlignedBillboardSceneNode : virtual public IBillboardSceneNode {
public:
  //! constructor
  YAlignedBillboardSceneNode(ISceneNode *parent, ISceneManager *mgr, s32 id,
  ...
  virtual void getSize(f32 &height, f32 &bottomEdgeWidth,
  ...
  virtual void
  serializeAttributes(io::IAttributes *out,
                      io::SAttributeReadWriteOptions *options = 0) const;

  //! Reads attributes of the scene node.
  virtual void
  deserializeAttributes(io::IAttributes *in,
  ...
  virtual ISceneNode *clone(ISceneNode *newParent = 0,
