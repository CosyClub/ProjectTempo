...
{
//! constructor
XZAlignedBillboardSceneNode::XZAlignedBillboardSceneNode(ISceneNode *                  parent,
                                                       ISceneManager *               mgr,
                                                       s32                           id,
...
{
#ifdef _DEBUG
	setDebugName("XZAlignedBillboardSceneNode");
#endif
...
//! pre render event
void XZAlignedBillboardSceneNode::OnRegisterSceneNode()
{
	if (IsVisible)
...
//! render
void XZAlignedBillboardSceneNode::render()
{
	...
	vertical.Y               = 0;  // no y
	vertical.normalize();          // just x and z
...
const core::aabbox3d<f32> &XZAlignedBillboardSceneNode::getBoundingBox() const
{
	return BBox;
}

//! sets the size of the billboard
void XZAlignedBillboardSceneNode::setSize(const core::dimension2d<f32> &size)
{
	Size = size;
...
void XZAlignedBillboardSceneNode::setSize(f32 height, f32 bottomEdgeWidth, f32 topEdgeWidth)
{
...
video::SMaterial &XZAlignedBillboardSceneNode::getMaterial(u32 i)
{
	return Material;
}

//! returns amount of materials used by this scene node.
u32 XZAlignedBillboardSceneNode::getMaterialCount() const
{
	return 1;
}

//! gets the size of the billboard
const core::dimension2d<f32> &XZAlignedBillboardSceneNode::getSize() const
{
	return Size;
}

//! Gets the widths of the top and bottom edges of the billboard.
void XZAlignedBillboardSceneNode::getSize(f32 &height, f32 &bottomEdgeWidth, f32 &topEdgeWidth) const
{
	height          = Size.Height;
...
void XZAlignedBillboardSceneNode::serializeAttributes(io::IAttributes *               out,
...
void XZAlignedBillboardSceneNode::deserializeAttributes(io::IAttributes *               in,
...
void XZAlignedBillboardSceneNode::setColor(const video::SColor &overallColor)
{
...
void XZAlignedBillboardSceneNode::setColor(const video::SColor &topColor,
...
void XZAlignedBillboardSceneNode::getColor(video::SColor &topColor, video::SColor &bottomColor) const
{
...
ISceneNode *XZAlignedBillboardSceneNode::clone(ISceneNode *newParent, ISceneManager *newManager)
{
	if (!newParent)
		newParent = Parent;
	if (!newManager)
	...
	XZAlignedBillboardSceneNode *nb =
	  new XZAlignedBillboardSceneNode(newParent, newManager, ID, RelativeTranslation, Size);
