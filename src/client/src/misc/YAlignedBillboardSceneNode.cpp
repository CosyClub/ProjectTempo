...
//! constructor
YAlignedBillboardSceneNode::YAlignedBillboardSceneNode(
...
void YAlignedBillboardSceneNode::setSize(f32 height, f32 bottomEdgeWidth,
                                         f32 topEdgeWidth) {
...
u32 YAlignedBillboardSceneNode::getMaterialCount() const { return 1; }
...
void YAlignedBillboardSceneNode::getSize(f32 &height, f32 &bottomEdgeWidth,
...
void YAlignedBillboardSceneNode::serializeAttributes(
...
void YAlignedBillboardSceneNode::deserializeAttributes(
...
void YAlignedBillboardSceneNode::getColor(video::SColor &topColor,
...
ISceneNode *YAlignedBillboardSceneNode::clone(ISceneNode *newParent,
  ...
  YAlignedBillboardSceneNode *nb = new YAlignedBillboardSceneNode(
      newParent, newManager, ID, RelativeTranslation, Size);
