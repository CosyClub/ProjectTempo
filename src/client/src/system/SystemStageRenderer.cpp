                                                      ...
                                                      glm::ivec4 colour1, glm::ivec4 colour2)
{
	...
	this->mesh->getMeshBuffer(1)->getMaterial().EmissiveColor.set(colour1[0], colour1[1], colour1[2], colour1[3]);
...
void SystemStageRenderer::setTileColor(glm::ivec2 pos, glm::ivec3 color)
{
	colorDeltaMap[color].push_back(pos);
}

void SystemStageRenderer::colorStage(int                        j,
                                     glm::ivec2                 playerpos,
                                     glm::vec3                  C1,
				     glm::vec3                  C2)
{
	...
	for (unsigned int i = 0; i < this->tile_nodes.size(); ++i) {
		...
		case 10:
		case 11:
		case 12: render = checkerBoardPattern(i, j); break;
		case 4:
		case 5:
		case 6:
		case 7:
		case 8: render = linePattern(0, 5, i, j - 4); break;
		case 13:
		case 14:
		case 15:
		case 16:
		case 17: render = linePattern(1, 5, i, j - 13); break;
		case 18:
		case 19:
		case 20:
		case 21: render = squarePattern(1, 12, i, j); break;
		}
                                 ...
                                 irr::video::IVideoDriver * driver)
{
	...
	{
		glm::ivec3 c = it.first;
		std::vector<glm::ivec2> ps = it.second;
		for (glm::ivec2 p : ps)
		{
			irr::video::SColor color(255, c.x, c.y, c.z);
			this->mesh->getMeshBuffer(1)->getMaterial().EmissiveColor = color;
...
inline bool SystemStageRenderer::checkerBoardPattern(int                       i,
                                                     int                       j)
{
...
inline bool SystemStageRenderer::linePattern(int                       orientation,
                                             int                       size,
                                             int                       i,
                                             int                       j)
{
