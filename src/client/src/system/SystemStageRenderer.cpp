                                      ...
                                      int                       j)
{
	...
	case 10:
	case 11:
	case 12: checkerBoardPattern(driver, heights, colour1, colour2, j); break;
	case 4:
	case 5:
	case 6:
	case 7:
	case 8: linePattern(driver, heights, colour1, colour2, 0, 5, j - 4); break;
	case 13:
	case 14:
	case 15:
	case 16:
	case 17: linePattern(driver, heights, colour1, colour2, 1, 5, j - 13); break;
	case 18:
	case 19:
	case 20:
	case 21: squarePattern(driver, heights, colour1, colour2, 1, 12, j); break;

	}
}

inline bool SystemStageRenderer::updatePosition(irr::scene::IMeshSceneNode* node,
                                                     ...
                                                     int                         j)
{
  ...
  for (unsigned int i = 0; i < this->tile_nodes.size(); ++i) {
    ...
    if (!updatePosition(node, heights, i)) continue;
