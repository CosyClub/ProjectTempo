...
class ComponentGridPosition : public anax::Component
{
   ...
   public:
	...
	inline const TileMask &getTileMask()
	{
		return this->mask;
	}
	inline const bool isEthereal()
	{
	...
	ComponentGridPosition(int x, int y, TileMask = tempo::tileMask1by1, bool is_ethereal = true);
...
class ComponentGridMotion : public anax::Component
{
   ...
   public:
	...
	inline bool beginMovement(glm::vec2 delta)
	{
		return beginMovement(delta.x, delta.y);
	}
...
/////////////////////////////////////////////////////////////////////
class SystemLevelManager
    : public anax::System<anax::Requires<ComponentGridPosition, ComponentGridMotion>>
{
   private:
